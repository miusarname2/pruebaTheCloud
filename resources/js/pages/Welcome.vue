    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">Bienvenido al Gestor de Tareas</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Organiza tu vida con nuestro potente gestor de tareas. <br />Descubre las funcionalidades que te ofrecemos.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                <strong>Crear Tareas:</strong> Agrega nuevas tareas con título, descripción, fecha límite y prioridad.
                            </span>
                        </li>
                        <li
                        ...
                        >
                            ...
                            <span>
                                <strong>Leer y Organizar:</strong> Visualiza todas tus tareas, filtra por estado y prioridad.
                            </span>
                        </li>
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                        >
                            ...
                            <span>
                                <strong>Actualizar Tareas:</strong> Edita detalles de tus tareas en cualquier momento.
                            </span>
                        </li>
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                        >
                            ...
                            <span>
                                <strong>Eliminar Tareas:</strong> Remueve tareas completadas o innecesarias.
                            </span>
                        </li>
                    </ul>
